...
export function Terminal() {
  ...
  // boot handshake: tell the watchdog we mounted, and drop the SSR shell
  useEffect(() => {
    (window as unknown as { __MP_STATUS?: string }).__MP_STATUS = "hydrated";
    document.getElementById("mp-shell")?.remove();
  }, []);
